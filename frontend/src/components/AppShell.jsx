...
const TITLES = {
  "/staff": {
    title: "Arshi Enterprises - Staff Panel",
...
const AppShell = () => {
  ...
  const content = useMemo(() => TITLES[location.pathname] || TITLES["/staff"], [location.pathname]);
    ...
    <div className="min-h-screen bg-transparent">
      ...
      <div className="md:pl-[290px]">
        <header className="sticky top-0 z-20 border-b border-line/70 bg-white/80 backdrop-blur">
          <div className="mx-auto flex max-w-[1500px] flex-col gap-4 px-4 py-4 sm:flex-row sm:items-center sm:justify-between sm:px-6 lg:px-10">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <h2 className="text-2xl font-bold text-ink truncate max-w-[14rem] sm:max-w-none">{content.title}</h2>
              </div>
            </div>
        ...
        <main className="mx-auto max-w-[1500px] px-4 py-6 sm:px-6 lg:px-10 lg:py-8">
          <div className="mb-6 rounded-[32px] border border-line/60 bg-white/70 p-5 shadow-[0_20px_50px_rgba(15,23,42,0.06)] sm:p-6">
