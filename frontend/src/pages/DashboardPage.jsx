...
import { downloadExcelReport, downloadPdfReport } from "../utils/reportDownload";
      ...
      <section className="panel p-6">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <p className="mt-2 text-sm text-muted">Export scoped data as CSV or download daily and monthly PDF summaries.</p>
          </div>
          <div className="flex flex-col gap-3 sm:flex-row">
            ...
            <button
              ...
              disabled={Boolean(exporting)}
            >
              {exporting === "daily" ? "Preparing..." : "Daily PDF"}
            </button>
            <button
              type="button"
              ...
              disabled={Boolean(exporting)}
            >
              {exporting === "monthly" ? "Preparing..." : "Monthly PDF"}
            </button>
          </div>
        </div>
      </section>
